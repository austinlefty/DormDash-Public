package com.dormdash.android.ui.util
...
import com.dormdash.android.ui.Constants
...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(mapOf(
                "gateway" to "braintree",
                "braintree:apiVersion" to "v1",
                "braintree:sdkVersion" to "braintree.client.4.1.1" ,
                "braintree:merchantId" to "zztjstsj8xp4ypyv",
                "braintree:clientKey" to "sandbox_zjbmy58h_zztjstsj8xp4ypyv"
            )))
        }
    }
     ...
     * //ZB: Added allowed card networks
